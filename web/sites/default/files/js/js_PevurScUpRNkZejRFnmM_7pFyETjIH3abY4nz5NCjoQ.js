...
var etiquetas = document.querySelectorAll('.svg_mas_datos');
for (var i=0; i < etiquetas.length; i++) {
    etiquetas[i].setAttribute("viewBox", "0 220 1084 1084");
}
;
/**
* DO NOT EDIT THIS FILE.
