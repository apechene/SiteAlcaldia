 ...
 * )
 */
class ResponsiveMediaThumbnailFormatter extends ImageFormatterBase implements ContainerFactoryPluginInterface {
  ...
  public function viewElements(FieldItemListInterface $items, $langcode) {
    ...
    foreach ($media_items as $delta => $media) {
      $field_parent = $media->_referringItem->getEntity();
      $media_parent_id = $field_parent->get($field_name)->getValue()[0]['target_id'];
      $parent_media = $this->parentMediaStorage->load($media_parent_id);
      $parent_media_alt_tag = $parent_media->get('field_media_image')->getValue()[0]['alt'];
