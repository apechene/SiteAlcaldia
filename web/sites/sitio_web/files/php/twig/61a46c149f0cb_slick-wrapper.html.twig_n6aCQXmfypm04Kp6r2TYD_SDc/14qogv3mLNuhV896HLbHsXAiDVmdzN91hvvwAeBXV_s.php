...
/* sites/sitio_web/modules/slick/templates/slick-wrapper.html.twig */
class __TwigTemplate_1c33fea6059fa50594ad999f2e36bbae4eb7f0b86fa22557ca79b9bda81a4ce9 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["settings"] ?? null), "thumbnail_position", [], "any", false, false, true, 25))) ? (("slick-wrapper--tn-" . twig_replace_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["settings"] ?? null), "thumbnail_position", [], "any", false, false, true, 25), 25, $this->source), ["over-" => ""]))) : (""))];
  ...
  ";
    ...
    {
        return "sites/sitio_web/modules/slick/templates/slick-wrapper.html.twig";
    }
...
{% spaceless %}
  ...
  {% endif %}
{% endspaceless %}
", "sites/sitio_web/modules/slick/templates/slick-wrapper.html.twig", "/home/u442037593/domains/pruebasanderson.xyz/public_html/web/sites/sitio_web/modules/slick/templates/slick-wrapper.html.twig");
    }
