...
c2c.init = function () {
    ...
    document.write(
        "<a href='#' class='btn btn-large btn-success' id='c2c_btn_call'>call us &raquo;</a>"
    );
    document.write(
    ...
    c2c.button_call.onclick = function () {
        if (!c2c.stack) {
            ...
            c2c.stack = new SIPml.Stack({ realm: 'vbarrera.tk', impi: c2c.from, impu: 'sip:' + c2c.from + '@vbarrera.tk', password: 'Cart*2018',
