...
?>
<div class="<?php print implode(' ', $categories); ?> pi-col-md-<?php print $bootsrap_class; ?> pi-col-sm-4 pi-col-xs-6 isotope-item">
      ...
      <div class="pi-caption-centered">
        <div>
          ...
          <ul class="pi-caption-links">
            ...
            <li><i class="icon-user"></i><a href="<?php print url('user/' . $fields['uid']->content); ?>"><?php print t('Author'); ?></a></li>
          </ul>
          <?php endif; ?>
