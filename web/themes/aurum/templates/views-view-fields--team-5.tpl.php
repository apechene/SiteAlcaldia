...
<div class="pi-gallery-item pi-padding-bottom-20 pi-text-center">
  <div class="pi-img-w pi-img-round pi-img-grayscale-hover">
    <a href="<?php print $fields['path']->content; ?>" class="pi-img-link">
      <span class="pi-img-border">
        <?php print $fields['field_image']->content; ?>
      </span>
    </a>
  </div>
  <h6 class="pi-weight-700 pi-uppercase pi-letter-spacing"><?php print $fields['title']->content; ?></h6> 
