 ...
 */
global $recent_posts_counter;
$recent_posts_counter = isset($recent_posts_counter) ? $recent_posts_counter + 1 : 1;
?>
...
<?php if($recent_posts_counter != count($view->result)): ?>
  <hr class="pi-divider pi-divider-dashed">
<?php else: $recent_posts_counter = 0; endif;?>