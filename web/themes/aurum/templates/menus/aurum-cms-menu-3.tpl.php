        ...
        <div class="pi-row-block pi-pull-right pi-hidden-md">
          <?php
            if(module_exists('search')) {
              ...
              $search_form_box['content']['search_block_form']['#field_prefix'] = '<button type="submit" class="btn pi-btn-base"><i class="icon-search-1"></i></button><div class = "pi-input-inline">';
