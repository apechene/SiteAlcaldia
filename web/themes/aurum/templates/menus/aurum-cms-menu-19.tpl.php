<div class="pi-header">
  <div class="pi-section-w <?php print $menu_color; ?> pi-shadow-bottom">
    <div class="pi-section pi-row-lg">
      ...
      <?php if(theme_get_setting('menu_phone')): ?>
        <div class="pi-row-block pi-row-block-txt pi-hidden-2xs">
          <i class="pi-row-block-icon icon-phone pi-icon-circle <?php print $color == 'dark' ? 'pi-icon-dark' : '';?> pi-shadow-inset"></i><strong><?php print theme_get_setting('menu_phone'); ?></strong>
        </div>
      <?php endif; ?>
      <!-- End phone -->
      ...
      <?php if(theme_get_setting('menu_email')): ?>
        <div class="pi-row-block pi-row-block-txt pi-hidden-xs">
          <i class="pi-row-block-icon icon-mail pi-icon-circle <?php print $color == 'dark' ? 'pi-icon-dark' : '';?> pi-shadow-inset"></i><a href="mailto:<?php print theme_get_setting('menu_email'); ?>"><?php print theme_get_setting('menu_email'); ?></a>
        </div>
      <?php endif; ?>
      <!-- End email -->
      ...
      <div class="pi-row-block pi-pull-right pi-hidden-sm">
        <?php
          if(module_exists('search')) {
            ...
            $search_form_box['content']['search_block_form']['#field_suffix'] = '</div><button type="submit" class="btn pi-btn pi-btn-base' . ($color == 'base' ? '-2' : '') . '">' . t('Search') . '</button>';
