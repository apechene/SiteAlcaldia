<div class="pi-header">
  <div class="pi-header-sticky-height">
          ...
          <div class="pi-row-block pi-pull-right pi-hidden-sm">
            <?php
              if(module_exists('search')) {
                ...
                $search_form_box['content']['search_block_form']['#field_suffix'] = '</div><button type="submit" class="btn pi-btn pi-btn-base pi-btn-no-border"><i class="icon-search-1"></i></button>';
