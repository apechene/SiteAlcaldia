    ...
    <div class="pi-section pi-row-sm">
      ...
      <?php if(theme_get_setting('menu_address')): ?>
        <div class="pi-row-block pi-row-block-txt pi-hidden-xs">
          <i class="pi-row-block-icon icon-location pi-text-white"></i><?php print theme_get_setting('menu_address'); ?>
        </div>
      <?php endif; ?>
  ...
  <div class="pi-header-sticky">
    ...
    <div class="pi-section-w pi-row-reducible pi-border-top-light <?php print $menu_color; ?>">
      <div class="pi-section pi-row-lg">
        ...
        <div class="pi-row-block pi-row-block-txt pi-italic pi-hidden-2xs <?php print $text_color;?>"><?php print variable_get('site_slogan', ''); ?></div>
