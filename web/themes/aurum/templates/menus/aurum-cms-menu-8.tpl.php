      ...
      <div class="pi-section pi-row-lg">
        ...
        <?php if(theme_get_setting('menu_phone')): ?>
          <div class="pi-row-block pi-row-block-txt pi-hidden-2xs">
            ...
            <?php print t('Call Us:'); ?> <strong><?php print theme_get_setting('menu_phone'); ?></strong>
          </div>
        <?php endif; ?>
        ...
        <?php if(theme_get_setting('menu_social')): ?>
          <div class="pi-row-block pi-pull-right pi-hidden-md">
            <ul class="pi-social-icons pi-round-corners pi-jump <?php print $color == 'base' ? '' : 'pi-colored-bg pi-active-bg'; ?> pi-small">
