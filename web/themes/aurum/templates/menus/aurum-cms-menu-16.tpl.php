      ...
      <?php if(!$user->uid): ?>
        ...
        <div class="pi-row-block pi-pull-right pi-hidden-xs" style="margin-right: 6px;">
          <?php
            ...
            $form['actions']['submit']['#attributes']['class'][] = 'pi-btn-base-' . ($color == 'base' ? '-2' : '') . ' pi-btn-no-border';
    ...
    <div class="pi-section-w pi-row-reducible pi-border-top-light <?php print $menu_color; ?>">
      <div class="pi-section pi-row-lg">
        ...
        <?php if(theme_get_setting('menu_phone')): ?>
          <div class="pi-row-block pi-row-block-txt pi-big-font pi-weight-600 pi-hidden-2xs">
            <i class="pi-row-block-icon icon-mobile <?php print $color == 'dark' ? '' : 'pi-text-dark'; ?>"></i>
              <span class = "pi-text-<?php print $color == 'base' ? 'white' : 'base'; ?>"><?php print theme_get_setting('menu_phone'); ?></span>
          </div>
        <?php endif; ?>
